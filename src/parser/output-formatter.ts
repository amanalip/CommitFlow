...
const COMMAND_HELP: Record<string, CommandHelpEntry> = {
  ...
  stash: { usage: 'git stash [push|pop|drop|list|clear] [stash@{n}] [-m <message>]', summary: 'Temporarily store or restore uncommitted work.', examples: ['git stash -m "WIP navigation"', 'git stash list', 'git stash pop stash@{1}', 'git stash drop stash@{0}'] },
...
export function formatHelpText(): string {
  return [
    ...
    '  \x1b[36mgit stash [pop|drop|list|clear]\x1b[0m  Save, restore, inspect, or delete stashes',
