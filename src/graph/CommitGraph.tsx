...
import { exportGraphToPng } from './png-export';
  ...
  return (
    <div id="commitflow-graph-container" className={styles.graphContainer}>
      <div className={styles.graphControls}>
        <button className={styles.controlButton} onClick={() => fitView({ padding: 0.2, duration: 400 })} title="Fit graph to view">
          Fit View
        </button>
        <button className={styles.controlButton} onClick={handleExport} title="Export commit graph as PNG">
          Export PNG
        </button>
      </div>
